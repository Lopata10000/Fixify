...
BEGIN
    IF
NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'subcategory') THEN
CREATE TABLE subcategory
(
    subcategory_id        SERIAL PRIMARY KEY,
    subcategory_name   VARCHAR(255) NOT NULL,
    parent_category_id INT,
    FOREIGN KEY (ParentCategoryID) REFERENCES specialist_categories (category_id)  ON DELETE CASCADE
